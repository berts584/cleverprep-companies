...
const newRolesContent = fs.readFileSync('temp_servicenow_roles_batch2.js', 'utf8');

// Find lyft section to locate end of ServiceNow
...
// Find the last closing brace of ServiceNow section before lyft
const beforeLyft = mainContent.substring(0, lyftStart);
const lastRoleEnd = beforeLyft.lastIndexOf("    }");

if (lastRoleEnd === -1) {
  console.error("Could not find last role end in ServiceNow section");
  process.exit(1);
}
...
console.log("ServiceNow batch 2 roles inserted successfully!");
