    ...
    <div className="min-h-screen relative overflow-hidden bg-[#FFFBF5]">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-4xl mx-auto px-6 py-16 pb-40">
          ...
          <section className="mb-16">
            <h2 className="text-4xl md:text-5xl font-black font-display text-[#1E3A8A] mb-12 text-center">Why Candidates Choose Our Prep</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="group hover-lift glass-card p-8 rounded-3xl text-center border-2 border-[#1E3A8A]/10">
                <div className="flex justify-center mb-6">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#F59E0B] to-yellow-600 flex items-center justify-center">
                    <svg className="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  </div>
                </div>
                <h3 className="text-2xl font-bold mb-3 text-[#1E3A8A]">2,400+ Alumni</h3>
                <p className="text-gray-700 text-lg leading-relaxed">Candidates who landed their dream role with our prep</p>
              </div>
              <div className="group hover-lift glass-card p-8 rounded-3xl text-center border-2 border-[#1E3A8A]/10">
                <div className="flex justify-center mb-6">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#1E3A8A] to-blue-600 flex items-center justify-center">
                    <svg className="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                  </div>
                </div>
                <h3 className="text-2xl font-bold mb-3 text-[#1E3A8A]">Industry Experts</h3>
                <p className="text-gray-700 text-lg leading-relaxed">Prep materials created by former hiring managers</p>
              </div>
              <div className="group hover-lift glass-card p-8 rounded-3xl text-center border-2 border-[#1E3A8A]/10">
                <div className="flex justify-center mb-6">
                ...
                <h3 className="text-2xl font-bold mb-3 text-[#1E3A8A]">10-Minute Setup</h3>
                <p className="text-gray-700 text-lg leading-relaxed">Get instant access to your personalized prep package</p>
              </div>
            </div>
          </section>
