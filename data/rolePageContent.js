...
export const rolePageContent = {
  ...
  'morgan-stanley': {
    ...
    'investment-banking-associate': {
      roleDescription: "Investment Banking Associates at Morgan Stanley combine elite deal execution with a culture emphasizing sustainable excellence and career development. Associates join through top MBA programs or internal promotion, leading complex transactions while mentoring analysts and building client relationships. Morgan Stanley's strength in M&A advisory and collaborative culture attracts Associates seeking prestigious deals with better work-life integration than competitors.",
      responsibilities: [
        "Lead M&A, IPO, and capital markets deal execution from mandate to close",
        "Build sophisticated merger models, LBOs, and strategic valuations",
        "Manage analyst teams - delegate, review, mentor",
        "Participate in client meetings and board presentations",
        "Draft transaction documents and offering materials",
        "Conduct industry analysis and competitive assessments",
        "Collaborate with VPs/MDs on deal strategy",
        "Coordinate across legal, compliance, and capital markets",
        "Support business development and pitch preparation"
      ],
      growthOpportunities: ["VP promotion in 3-4 years", "High-profile M&A and capital markets deals", "PE/HF exits", "Training and leadership programs", "Sector expertise development", "Managing Director track", "Global assignments", "$350-550K compensation potential"],
      interviewProcess: [{step:1,title:"Initial Screening",description:"30-45min call on background and motivation. MBA performance or analyst feedback evaluated.",duration:"30-45 minutes"},{step:2,title:"Technical Round",description:"60-90min testing technical mastery. Case studies on valuation and deal structuring.",duration:"60-90 minutes"},{step:3,title:"Superday",description:"4-6 interviews on technical skills, leadership, cultural fit.",duration:"4-6 hours"},{step:4,title:"Offer",description:"Committee reviews feedback. Offers $175-200K base plus bonus."}],
      technicalQuestions: ["How would you advise a board on strategic alternatives?","Compare two acquisition targets - framework?","Merger model: 22x vs 16x P/E, 50/50 cash/stock accretive?","Acquisition vs returning cash - how advise?","LBO structuring and returns required?","SOTP vs consolidated DCF?","Stock discount to peers - explanations?","EV to equity value bridge?","Vertical vs horizontal acquisition analysis?","Spin-off value creation analysis?","Tech vs industrial valuation approaches?","Take-private from both perspectives?","Optimal capital structure factors?","Secondary offering dilution?","Cash-free debt-free EV vs consideration?","Cross-border with FX/tax complexity?"],
      behavioralQuestions: ["Why Morgan Stanley Associate role?","Most complex deal and your role?","Managing underperformer?","Disagreeing with senior banker?","Delivering difficult client news?","Managing multiple deadlines?","Identifying critical errors?","Mentoring philosophy?","Deal that fell apart?","Pushback on seniors?","Why MS vs PE/others?","Career trajectory?","High-stakes judgment call?","Staying current?","Exceeding expectations?"],
      whatTheyLookFor: ["Technical modeling expertise","Leadership capabilities","Client-facing skills","Strategic thinking","75-90 hour work ethic","Sound judgment","Collaboration skills","Industry knowledge","C-suite maturity","MS cultural fit","Long-term commitment"],
      interviewTips: ["Prepare deal stories","Master merger models","Research MS deals","Practice case studies","Clear career narrative","Leadership examples","Research interviewers","Discuss market conditions","Thoughtful questions","Explain banking choice","Show client readiness","Understand MS positioning","Explain concepts simply","Show enthusiasm","Discuss work-life honestly"],
      salary: {min:175000,max:200000},
      compensation: ["$175-200K base (MBA), $150-175K (promoted)","$150-300K bonus","$25-50K signing","Guaranteed bonus","Stub bonus","Free dinner 7pm+","Car service","Health/dental/vision","401(k) match","Parental leave","Relocation","$350-550K total"],
      dayInLife: {overview:"70-85 hour weeks with workflow control. Balance hands-on work, team management, client interaction. Collaborative culture with reasonable hours.",schedule:[{time:"8:30 AM",activity:"Morning Prep",description:"Review emails, markets, priorities"},{time:"9:00 AM",activity:"Team Meeting",description:"Lead analyst meeting on deals"},{time:"9:45 AM",activity:"Client Strategy",description:"Join MD on M&A strategy"},{time:"11:00 AM",activity:"Modeling",description:"Build merger model scenarios"},{time:"12:30 PM",activity:"Working Lunch",description:"Review analyst work"},{time:"1:30 PM",activity:"Client Meeting",description:"Board presentation, valuation Q&A"},{time:"3:30 PM",activity:"Follow-Up",description:"Debrief and coordinate next steps"},{time:"4:30 PM",activity:"Pitch Dev",description:"Build pitch sections"},{time:"6:00 PM",activity:"Mentoring",description:"Analyst one-on-one"},{time:"7:00 PM",activity:"Dinner",description:"Brief break"},{time:"7:30 PM",activity:"Quality Review",description:"Review all analyst deliverables"},{time:"9:30 PM",activity:"Updates",description:"Send status to seniors"},{time:"10:30 PM",activity:"Wrap",description:"Home ~11pm typical"}]},
    ...
    'equity-research-analyst': {
      roleDescription: "Equity Research Analysts at Morgan Stanley deliver high-quality investment analysis to institutional investors. You'll publish research reports, earnings analyses, and recommendations that influence investing. Morgan Stanley research offers intellectually stimulating work, better work-life balance than banking, and strong buy-side exits.",
      responsibilities: ["Build financial models with quarterly updates","Publish research reports with recommendations","Conduct primary research","Analyze earnings and SEC filings","Develop differentiated views","Host client calls","Monitor industry trends","Collaborate with sales/trading","Attend conferences and meetings"],
      growthOpportunities: ["Senior Analyst promotion","Research rankings (II, StarMine)","Sector expertise recognition","HF/AM exits","C-suite access","Investor network","Banking/VC transitions","$400K-$800K+ potential"],
      interviewProcess: [{step:1,title:"Phone Screen",description:"30-45min on background and sector interests.",duration:"30-45 minutes"},{step:2,title:"Stock Pitch",description:"60-90min with stock pitch and technical questions.",duration:"60-90 minutes"},{step:3,title:"Superday",description:"4-5 interviews with analysts and research head.",duration:"4-5 hours"},{step:4,title:"Offer",description:"$85-105K base for undergrad, $110-130K MBA."}],
      technicalQuestions: ["Valuation framework?","EV vs equity value?","DCF assumptions and pitfalls?","Three statements linked?","Tech vs industrial valuation?","GAAP vs adjusted EBITDA?","Valuation multiples usage?","Free cash flow importance?","ROIC drivers?","Comp analysis?","One-time adjustments?","Normalized earnings?","Growth/margins/multiples?","PEG limitations?","M&A evaluation?","Business model transition valuation?"],
      behavioralQuestions: ["Why research? Why MS?","Stock pitch summary?","Sector interests?","Staying current?","Differentiated conclusion?","Changed view?","Research challenges?","MD disagreement?","Defending controversial view?","Conviction process?","Quant vs qual balance?","Recent analysis?","Great vs good analyst?","Learning new sector?","Why MS platform?","Interesting company?"],
      whatTheyLookFor: ["Analytical skills","Intellectual curiosity","Communication abilities","Independent thinking","Finance understanding","Detail precision","Industry knowledge","C-suite maturity","Earnings season work ethic","Team collaboration","Research integrity"],
      interviewTips: ["Polished 10min stock pitch","Deep sector knowledge","Read MS research","Master valuations","Daily market reading","Model building practice","Understand sell-side","Thoughtful questions","Research MS rankings","Multiple investment ideas","Show analysis passion","Anticipate counterarguments","Know market environment","Regulatory awareness","Explain simply"],
      salary: {min:85000,max:105000},
      compensation: ["$85-105K base (undergrad)","$110-130K (MBA)","$35-75K bonus","$10-25K signing","$130-205K total first year","Rankings boost pay","Seniors $400K-$800K+","Earnings season dinners","Health insurance","401(k) match","Parental leave","CFA support"],
      dayInLife: {overview:"7am-7pm normally, 9-10pm earnings season. Fundamental analysis focus. Sector expertise development.",schedule:[{time:"7:00 AM",activity:"Market Review",description:"Check overnight news"},{time:"8:00 AM",activity:"Team Meeting",description:"Discuss developments"},{time:"9:00 AM",activity:"Model Update",description:"Post-earnings revisions"},{time:"10:30 AM",activity:"Management Call",description:"CFO/IR call"},{time:"12:00 PM",activity:"Working Lunch",description:"Read competitor research"},{time:"1:00 PM",activity:"Client Call",description:"HF PM thesis debate"},{time:"2:30 PM",activity:"Research Writing",description:"Draft report update"},{time:"4:00 PM",activity:"Expert Call",description:"Industry insights"},{time:"5:00 PM",activity:"Report Review",description:"Senior analyst feedback"},{time:"6:00 PM",activity:"Final Edits",description:"Incorporate feedback"},{time:"7:00 PM",activity:"Wrap",description:"Submit and depart"}]},
      similarRoles: [{companyName:"Goldman Sachs",companySlug:"goldman-sachs",industry:"Finance"},{companyName:"JPMorgan Chase",companySlug:"jpmorgan",industry:"Finance"},{companyName:"Bank of America",companySlug:"bank-of-america",industry:"Finance"},{companyName:"Citigroup",companySlug:"citigroup",industry:"Finance"},{companyName:"Wells Fargo",companySlug:"wells-fargo",industry:"Finance"}]
    },
    'sales-trading-analyst': {
      roleDescription: "Sales & Trading Analysts at Morgan Stanley join a premier trading platform serving elite institutional clients. Work in Institutional Securities across equities, fixed income, currencies, commodities. Role splits between Sales (client coverage) and Trading (market making). Sophisticated products, cutting-edge technology, competitive but supportive environment.",
      responsibilities: ["Execute institutional trades","Monitor markets and manage risk","Build pricing models","Manage P&L","Develop client relationships","Analyze market data","Collaborate across teams","Prepare market commentary","Support during volatility events"],
      growthOpportunities: ["Associate in 2-3 years","Product specialization","Senior trader/sales roles","Global rotations","HF/prop trading exits","Markets expertise","Advanced technology","Performance-based comp"],
      interviewProcess: [{step:1,title:"Phone Screen",description:"30-45min on markets interest and quant skills.",duration:"30-45 minutes"},{step:2,title:"HireVue/Technical",description:"45-75min on market knowledge, probability.",duration:"45-75 minutes"},{step:3,title:"Superday",description:"4-6 interviews on technical, markets, fit.",duration:"4-6 hours"},{step:4,title:"Offer",description:"$85-110K base, bonus structure, desk assignment."}],
      technicalQuestions: ["60% heads coin, $100 win/$50 loss EV?","Bond prices and rates?","Call/put and Greeks?","Market-making $100 bid/$100.10 offer?","Stock gap factors?","Hedge equity position?","Spot/forward/rate differentials?","65 heads in 100 flips fair?","Implied vs realized vol?","Forward valuation?","S&P down 2%, stock up 1%?","Delta/gamma/vega/theta?","Fed 50bp hike impacts?","Risk types?","2y above 10y signal?","$50M bond 10bp P&L?"],
      behavioralQuestions: ["Why S&T? Why MS?","Sales vs trading preference?","Quick decision example?","Asset class interest?","Pressure performance?","Markets this week?","Mistake handling?","Good trader/salesperson?","Staying current?","Quant problem-solving?","Trade idea now?","Competitive success?","Explaining derivatives?","Market views?","Tight deadlines?","Why MS platform?"],
      whatTheyLookFor: ["Quantitative skills","Markets passion","Quick thinking","Competitive drive","Communication","Emotional control","Team player","Market intuition","Risk discipline","Intellectual curiosity","MS cultural fit"],
      interviewTips: ["Follow markets daily","Master probability/math","Understand mechanics","Market views prep","Practice puzzles","Research desks","S&T narrative","Show personality","Trade ideas ready","Know MS position","Sales: communication","Trading: analytics","Discuss volatility","Think out loud","Show humility"],
  ...
  'bank-of-america': {
    ...
    'investment-banking-associate': {
      roleDescription: "Investment Banking Associates at Bank of America work within BofA Securities' extensive platform, leveraging the largest balance sheet on Wall Street and integrated commercial banking relationships. Associates lead deal execution while developing teams in a collaborative, supportive culture emphasizing work-life balance and professional development.",
      responsibilities: ["Lead deal execution end-to-end","Build complex merger models and valuations","Manage and mentor analyst teams","Participate in client meetings and presentations","Draft transaction documents","Conduct industry analysis","Collaborate with senior bankers on strategy","Coordinate across internal functions","Support pitch development"],
      growthOpportunities: ["VP in 3-4 years","Diverse M&A and capital markets deals","PE/HF/corp dev exits","Training programs","Commercial banking integration insights","Global opportunities","Internal mobility","$325-500K comp potential"],
      interviewProcess: [{step:1,title:"Screening",description:"30-45min background and motivation discussion.",duration:"30-45 minutes"},{step:2,title:"Technical",description:"60-90min testing deal experience and technical skills.",duration:"60-90 minutes"},{step:3,title:"Superday",description:"4-6 interviews on technical, leadership, fit.",duration:"4-6 hours"},{step:4,title:"Offer",description:"$170-195K base, bonus, group placement."}],
      technicalQuestions: ["Board strategic alternatives framework?","Compare acquisition targets?","Merger accretion/dilution?","Acquisition vs capital return advice?","LBO structuring?","SOTP valuation?","Stock trading discount analysis?","EV to equity bridge?","Vertical vs horizontal M&A?","Spin-off value analysis?","Valuation approach differences?","Take-private analysis?","Capital structure optimization?","Dilution in secondary offering?","Cash-free debt-free EV?","Cross-border complexity?"],
      behavioralQuestions: ["Why BofA Associate?","Complex deal experience?","Managing underperformance?","Disagreeing with seniors?","Difficult client news?","Multiple deadlines?","Error identification?","Mentoring approach?","Failed deal experience?","Pushback situations?","Why BofA vs alternatives?","Career path?","Judgment under uncertainty?","Market awareness?","Exceeding expectations?"],
      whatTheyLookFor: ["Technical expertise","Leadership skills","Client management","Strategic thinking","Work ethic for 70-85 hours","Good judgment","Collaboration","Industry knowledge","Professional maturity","BofA culture fit","Commitment"],
      interviewTips: ["Deal stories prepared","Master technical topics","Research BofA deals","Practice cases","Clear career story","Leadership examples","Research interviewers","Market discussion ready","Prepare questions","Banking choice explanation","Client readiness shown","BofA positioning understood","Simple explanations","Show enthusiasm","Balance discussion"],
      salary: {min:170000,max:195000},
      compensation: ["$170-195K base","$130-280K bonus","$20-40K signing","Guaranteed bonus possible","Stub bonus","Dinner allowance","Car service","Health benefits","401(k) match","Parental leave","Relocation help","$325-500K total"],
      dayInLife: {overview:"70-85 hours with focus on efficiency. Balance execution, management, client work. Collaborative culture.",schedule:[{time:"8:30 AM",activity:"Morning",description:"Review priorities"},{time:"9:00 AM",activity:"Team Meeting",description:"Analyst coordination"},{time:"10:00 AM",activity:"Client Prep",description:"Meeting preparation"},{time:"11:00 AM",activity:"Modeling",description:"Build valuations"},{time:"12:30 PM",activity:"Lunch",description:"Working meal"},{time:"1:30 PM",activity:"Client Meeting",description:"Presentation"},{time:"3:00 PM",activity:"Follow-Up",description:"Action items"},{time:"4:30 PM",activity:"Pitch Work",description:"New business"},{time:"6:00 PM",activity:"Mentoring",description:"Analyst development"},{time:"7:00 PM",activity:"Dinner",description:"Brief break"},{time:"7:30 PM",activity:"Review",description:"Quality check"},{time:"9:00 PM",activity:"Updates",description:"Senior communication"},{time:"10:00 PM",activity:"Wrap",description:"Depart ~10:30pm"}]},
    ...
    'equity-research-analyst': {
      roleDescription: "Equity Research Analysts at Bank of America deliver investment analysis through BofA Securities Research. Publish reports, cover sectors, serve institutional clients. Supportive culture, reasonable hours, strong training.",
      responsibilities: ["Build financial models","Publish research reports","Conduct primary research","Analyze earnings","Develop investment views","Host client calls","Monitor trends","Collaborate with sales/trading","Attend industry events"],
      growthOpportunities: ["Senior Analyst","Rankings potential","Sector expertise","Buy-side exits","Management access","Investor network","Career transitions","$350K-$700K+ senior comp"],
      interviewProcess: [{step:1,title:"Phone",description:"30-45min background and interests.",duration:"30-45 minutes"},{step:2,title:"Stock Pitch",description:"60-90min pitch and technical.",duration:"60-90 minutes"},{step:3,title:"Superday",description:"4-5 interviews with team.",duration:"4-5 hours"},{step:4,title:"Offer",description:"$85-100K base UG, $105-125K MBA."}],
      technicalQuestions: ["Valuation methods?","EV vs equity?","DCF build?","Statements linked?","Growth vs value valuation?","GAAP vs EBITDA?","Multiple usage?","FCF calculation?","ROIC importance?","Comps selection?","Adjustments process?","Normalized earnings?","Multiple drivers?","PEG ratio?","M&A impact?","Transition valuation?"],
      behavioralQuestions: ["Why research BofA?","Stock idea?","Sector interest?","Market awareness?","Differentiated view?","View change?","Research evolution?","MD disagreement?","Controversial defense?","Conviction building?","Quant/qual balance?","Analysis example?","Great analyst traits?","New sector learning?","BofA platform?","Interesting stock?"],
      whatTheyLookFor: ["Analytical ability","Curiosity","Communication","Independent thinking","Finance knowledge","Detail orientation","Industry understanding","Professional polish","Work ethic","Collaboration","Integrity"],
      interviewTips: ["Strong stock pitch","Sector expertise","Read BofA research","Master valuation","Market reading","Modeling practice","Understand business","Good questions","Research rankings","Multiple ideas","Show passion","Counter-args ready","Market knowledge","Regulatory aware","Explain clearly"],
      salary: {min:85000,max:100000},
      compensation: ["$85-100K base (UG)","$105-125K (MBA)","$30-65K bonus","$10-20K signing","$125-190K total Y1","Rankings increase pay","Seniors $350K-$700K+","Meal allowances","Health benefits","401(k)","Parental leave","CFA support"],
      dayInLife: {overview:"7am-7pm normal, 9pm earnings. Analysis focus. Sector development. Reasonable balance.",schedule:[{time:"7:00 AM",activity:"Markets",description:"Review overnight"},{time:"8:00 AM",activity:"Meeting",description:"Team sync"},{time:"9:00 AM",activity:"Model",description:"Updates"},{time:"10:30 AM",activity:"Management",description:"Company call"},{time:"12:00 PM",activity:"Lunch",description:"Research reading"},{time:"1:00 PM",activity:"Client",description:"Investor call"},{time:"2:30 PM",activity:"Writing",description:"Report draft"},{time:"4:00 PM",activity:"Expert",description:"Channel check"},{time:"5:00 PM",activity:"Review",description:"Feedback"},{time:"6:00 PM",activity:"Edits",description:"Final touches"},{time:"7:00 PM",activity:"Wrap",description:"Submit and leave"}]},
      similarRoles: [{companyName:"Goldman Sachs",companySlug:"goldman-sachs",industry:"Finance"},{companyName:"JPMorgan Chase",companySlug:"jpmorgan",industry:"Finance"},{companyName:"Morgan Stanley",companySlug:"morgan-stanley",industry:"Finance"},{companyName:"Citigroup",companySlug:"citigroup",industry:"Finance"},{companyName:"Wells Fargo",companySlug:"wells-fargo",industry:"Finance"}]
    },
    'sales-trading-analyst': {
      roleDescription: "Sales & Trading Analysts at Bank of America work in Global Markets executing trades and serving institutional clients. Equities, FICC, derivatives coverage. Collaborative environment with strong technology and training.",
      responsibilities: ["Execute client trades","Monitor markets","Build models","Manage P&L","Client relationships","Market analysis","Team collaboration","Market commentary","Volatility support"],
      growthOpportunities: ["Associate 2-3 years","Product specialization","Senior roles","Global opportunities","Buy-side exits","Markets skills","Technology access","Performance comp"],
      interviewProcess: [{step:1,title:"Phone",description:"30-45min markets and quant.",duration:"30-45 minutes"},{step:2,title:"HireVue",description:"45-60min technical assessment.",duration:"45-60 minutes"},{step:3,title:"Superday",description:"4-6 interviews technical and fit.",duration:"4-6 hours"},{step:4,title:"Offer",description:"$85-105K base, bonus, desk."}],
      technicalQuestions: ["Biased coin EV?","Rates and bonds?","Options basics?","Market-making?","Gap factors?","Hedging?","FX parity?","Coin fair test?","Vol difference?","Forward pricing?","Beta interpretation?","Greeks?","Fed impact?","Risk types?","Curve inversion?","Bond P&L?"],
      behavioralQuestions: ["Why S&T BofA?","Sales vs trading?","Quick decision?","Asset interest?","Pressure handling?","Markets news?","Mistake response?","Trader qualities?","Market following?","Quant application?","Trade idea?","Competitive win?","Derivatives explanation?","Market view?","Deadline work?","BofA platform?"],
      whatTheyLookFor: ["Quant skills","Markets passion","Fast thinking","Competitiveness","Communication","Composure","Team fit","Market sense","Risk discipline","Curiosity","Culture match"],
      interviewTips: ["Follow markets","Master math","Know mechanics","Views prepared","Practice puzzles","Desk research","S&T story","Personality","Ideas ready","BofA strengths","Sales focus","Trading focus","Volatility knowledge","Vocal process","Humility"],
      salary: {min:85000,max:105000},
  ...
  'citigroup': {
    ...
    'investment-banking-associate': {
      roleDescription: "Investment Banking Associates at Citigroup leverage the firm's unmatched global platform spanning nearly 100 countries. Lead cross-border and emerging markets transactions while managing teams in an entrepreneurial environment emphasizing international perspective and professional development.",
      responsibilities: ["Lead global deal execution","Build cross-border models and valuations","Manage analyst teams","Participate in international client meetings","Draft multi-jurisdictional documents","Conduct global market analysis","Collaborate with senior bankers","Coordinate across regions","Support business development"],
      growthOpportunities: ["VP in 3-4 years","Unique emerging markets deals","Global PE/corporate exits","International training","Worldwide office opportunities","Cross-border specialization","Global platform access","$325-500K comp"],
      interviewProcess: [{step:1,title:"Screening",description:"30-45min on background and global interest.",duration:"30-45 minutes"},{step:2,title:"Technical",description:"60-90min on cross-border deals and skills.",duration:"60-90 minutes"},{step:3,title:"Superday",description:"4-6 interviews technical, leadership, global fit.",duration:"4-6 hours"},{step:4,title:"Offer",description:"$170-190K base plus bonus."}],
      technicalQuestions: ["Global strategic alternatives?","Cross-border target comparison?","Multi-currency merger model?","International acquisition advice?","Emerging market LBO?","Regional valuation differences?","FX impact analysis?","Global EV bridge?","Cross-border M&A structures?","International spin-off?","EM vs developed valuation?","Multi-jurisdictional deal?","Global capital structure?","ADR vs local listing?","Country risk adjustment?","Transfer pricing impact?"],
      behavioralQuestions: ["Why Citi Associate?","International deal experience?","Global team management?","Cross-cultural disagreement?","Emerging market challenges?","Multiple region coordination?","Error in global context?","International mentoring?","Failed cross-border deal?","Global stakeholder pushback?","Why Citi platform?","International career path?","EM judgment call?","Global awareness?","International exceeding?"],
      whatTheyLookFor: ["Technical expertise","Global mindset","Leadership","Strategic thinking","70-85 hour capability","Cross-cultural judgment","Collaboration","International knowledge","Professional maturity","Citi global fit","Long-term commitment"],
      interviewTips: ["International deal stories","Master cross-border tech","Research Citi EM deals","Practice global cases","International career narrative","Global leadership examples","Research backgrounds","Discuss regional dynamics","Global questions","EM interest explanation","International readiness","Citi positioning","Cultural explanations","Show global enthusiasm","Balance discussion"],
      salary: {min:170000,max:190000},
      compensation: ["$170-190K base","$125-275K bonus","$20-35K signing","Possible guarantee","Stub bonus","Meal allowances","Transportation","Health benefits","401(k)","Parental leave","Relocation","$320-500K total"],
      dayInLife: {overview:"70-85 hours with global coordination. Balance execution, management, international clients. Entrepreneurial culture.",schedule:[{time:"8:00 AM",activity:"Global Review",description:"Check international markets"},{time:"9:00 AM",activity:"Team",description:"Analyst sync"},{time:"10:00 AM",activity:"Int'l Prep",description:"Cross-border meeting prep"},{time:"11:00 AM",activity:"Modeling",description:"Multi-currency valuation"},{time:"12:30 PM",activity:"Lunch",description:"Working meal"},{time:"1:30 PM",activity:"Client",description:"EM presentation"},{time:"3:00 PM",activity:"Follow-Up",description:"Regional coordination"},{time:"4:30 PM",activity:"Pitch",description:"Global opportunity"},{time:"6:00 PM",activity:"Mentoring",description:"Development"},{time:"7:00 PM",activity:"Dinner",description:"Break"},{time:"7:30 PM",activity:"Review",description:"Quality check"},{time:"9:00 PM",activity:"Updates",description:"Global communication"},{time:"10:00 PM",activity:"Wrap",description:"Depart ~10:30pm"}]},
    ...
    'equity-research-analyst': {
      roleDescription: "Equity Research Analysts at Citigroup deliver global investment analysis with particular strength in emerging markets and international companies. Publish research serving worldwide institutional clients. International perspective, reasonable hours, strong training.",
      responsibilities: ["Build global models","Publish international research","Conduct cross-border research","Analyze global earnings","Develop EM views","Host international clients","Monitor worldwide trends","Collaborate globally","Attend international events"],
      growthOpportunities: ["Senior Analyst","Global rankings","International expertise","Worldwide buy-side exits","EM management access","Global network","International transitions","$350K-$700K+ senior"],
      interviewProcess: [{step:1,title:"Phone",description:"30-45min background and global interests.",duration:"30-45 minutes"},{step:2,title:"Stock Pitch",description:"60-90min international pitch and technical.",duration:"60-90 minutes"},{step:3,title:"Superday",description:"4-5 interviews with global team.",duration:"4-5 hours"},{step:4,title:"Offer",description:"$85-100K base UG, $105-120K MBA."}],
      technicalQuestions: ["Global valuation framework?","EV across currencies?","EM DCF adjustments?","International statements?","Developed vs EM valuation?","Local vs IFRS?","Global multiples?","Cross-border FCF?","Country risk in ROIC?","International comps?","Currency adjustments?","EM normalized earnings?","FX impact on multiples?","Sovereign risk PEG?","Cross-border M&A?","Political transition valuation?"],
      behavioralQuestions: ["Why Citi research?","International stock idea?","EM sector interest?","Global awareness?","Cross-cultural view?","International view change?","Global research challenges?","EM disagreement?","Controversial EM defense?","EM conviction?","Quant/qual in EM?","International analysis?","Global analyst traits?","Learning new region?","Citi global platform?","EM stock interest?"],
      whatTheyLookFor: ["Analytical ability","Global curiosity","Communication","Independent thinking","International finance knowledge","Detail precision","Cross-border understanding","Cultural maturity","Work ethic","Global collaboration","Research integrity"],
      interviewTips: ["International stock pitch","Global sector expertise","Read Citi EM research","Master global valuation","International news","Modeling practice","Understand EM business","Global questions","Research Citi rankings","Multiple region ideas","Show EM passion","Counter-args ready","Global market knowledge","Regulatory awareness","Cross-cultural explanation"],
      salary: {min:85000,max:100000},
      compensation: ["$85-100K base (UG)","$105-120K (MBA)","$30-60K bonus","$10-20K signing","$125-180K total Y1","Rankings boost","Seniors $350K-$700K+","Meal allowances","Health benefits","401(k)","Parental leave","CFA support"],
      dayInLife: {overview:"7am-7pm normal, 9pm earnings. Global analysis. International expertise. Reasonable balance.",schedule:[{time:"7:00 AM",activity:"Global Markets",description:"Review worldwide"},{time:"8:00 AM",activity:"Meeting",description:"Global team sync"},{time:"9:00 AM",activity:"Model",description:"EM updates"},{time:"10:30 AM",activity:"Management",description:"International call"},{time:"12:00 PM",activity:"Lunch",description:"Global research"},{time:"1:00 PM",activity:"Client",description:"International investor"},{time:"2:30 PM",activity:"Writing",description:"EM report"},{time:"4:00 PM",activity:"Expert",description:"Regional insights"},{time:"5:00 PM",activity:"Review",description:"Feedback"},{time:"6:00 PM",activity:"Edits",description:"Finalize"},{time:"7:00 PM",activity:"Wrap",description:"Depart"}]},
      similarRoles: [{companyName:"Goldman Sachs",companySlug:"goldman-sachs",industry:"Finance"},{companyName:"JPMorgan Chase",companySlug:"jpmorgan",industry:"Finance"},{companyName:"Morgan Stanley",companySlug:"morgan-stanley",industry:"Finance"},{companyName:"Bank of America",companySlug:"bank-of-america",industry:"Finance"},{companyName:"Wells Fargo",companySlug:"wells-fargo",industry:"Finance"}]
    },
    'sales-trading-analyst': {
      roleDescription: "Sales & Trading Analysts at Citigroup work across global markets with particular strength in emerging markets and international flow. Execute trades worldwide serving international institutional clients. Global platform, entrepreneurial culture.",
      responsibilities: ["Execute global trades","Monitor worldwide markets","Build international models","Manage multi-region P&L","International client relationships","Global market analysis","Worldwide collaboration","International commentary","Cross-border volatility"],
      growthOpportunities: ["Associate 2-3 years","EM/global specialization","International senior roles","Worldwide rotations","Global buy-side exits","Markets expertise","Global technology","Performance comp"],
      interviewProcess: [{step:1,title:"Phone",description:"30-45min markets and global interest.",duration:"30-45 minutes"},{step:2,title:"HireVue",description:"45-60min technical and EM knowledge.",duration:"45-60 minutes"},{step:3,title:"Superday",description:"4-6 interviews global technical and fit.",duration:"4-6 hours"},{step:4,title:"Offer",description:"$85-105K base, bonus, global desk."}],
      technicalQuestions: ["EM currency EV?","Sovereign bonds?","EM options?","Cross-border market-making?","Political risk gaps?","Hedging FX?","Interest rate parity?","EM statistical test?","EM vs DM vol?","EM forward pricing?","Correlation interpretation?","EM Greeks?","Central bank impact?","EM risk types?","Yield curve EM?","EM bond P&L?"],
      behavioralQuestions: ["Why Citi S&T?","Sales vs trading global?","EM quick decision?","Asset class EM interest?","EM pressure?","Global markets news?","EM mistake?","Global trader qualities?","International following?","EM quant problem?","EM trade idea?","Cross-border success?","EM derivatives?","EM view?","Global deadlines?","Citi global platform?"],
      whatTheyLookFor: ["Quant skills","Global markets passion","Fast thinking","Competitiveness","Cross-cultural communication","Composure","Global team fit","EM market sense","Risk discipline","International curiosity","Citi culture fit"],
      interviewTips: ["Follow EM markets","Master math","Know global mechanics","EM views prepared","Practice puzzles","Research EM desks","Global S&T story","International personality","EM ideas ready","Citi EM strengths","Sales focus","Trading focus","EM volatility knowledge","Vocal process","Humility"],
      salary: {min:85000,max:105000},
  ...
  'wells-fargo': {
    ...
    'investment-banking-associate': {
      roleDescription: "Investment Banking Associates at Wells Fargo combine meaningful middle-market deal work with entrepreneurial environment and better work-life balance. Lead transactions with earlier client responsibility in supportive, collaborative culture emphasizing practical execution and relationship banking.",
      responsibilities: ["Lead middle-market deal execution","Build practical models and valuations","Manage analyst teams","Participate actively in client meetings","Draft transaction documents","Conduct industry-focused analysis","Collaborate with senior bankers","Coordinate with commercial banking","Support pitch development"],
      growthOpportunities: ["VP in 3-4 years","Middle-market and large-cap deals","MM PE/corporate exits","Strong training","Commercial banking synergies","West Coast opportunities","Industry specialization","$300-475K comp"],
      interviewProcess: [{step:1,title:"Screening",description:"30-45min background and Wells Fargo interest.",duration:"30-45 minutes"},{step:2,title:"Technical",description:"60 min on deal experience and skills.",duration:"60 minutes"},{step:3,title:"Superday",description:"4-5 interviews technical, leadership, fit.",duration:"4-5 hours"},{step:4,title:"Offer",description:"$165-185K base plus bonus."}],
      technicalQuestions: ["MM strategic alternatives?","Target comparison framework?","Merger model accretion?","Return cash vs acquisition?","Middle-market LBO?","SOTP usage?","Valuation discount factors?","EV bridge?","M&A type analysis?","Spin-off evaluation?","Sector valuation differences?","MM take-private?","Capital structure MM?","Dilution analysis?","Cash-free EV?","Commercial banking integration?"],
      behavioralQuestions: ["Why Wells Fargo Associate?","MM deal experience?","Team management?","Senior disagreement?","Client challenge?","Deadline management?","Error finding?","Mentoring style?","Failed transaction?","Pushback example?","Why Wells Fargo platform?","Career vision?","MM judgment call?","Industry awareness?","Exceeding example?"],
      whatTheyLookFor: ["Technical skills","Entrepreneurial leadership","Client management","Practical thinking","70-80 hour ethic","Sound judgment","Collaboration","Industry knowledge","Client maturity","Wells Fargo fit","Commitment"],
      interviewTips: ["MM deal stories","Master fundamentals","Research Wells deals","Practice cases","Career narrative","Leadership examples","Research interviewers","Industry discussion","Prepare questions","Banking rationale","Client readiness","Wells positioning","Practical explanations","Show enthusiasm","Balance honest"],
      salary: {min:165000,max:185000},
      compensation: ["$165-185K base","$120-260K bonus","$20-35K signing","Possible guarantee","Stub bonus","Meal allowances","Transportation","Health benefits","401(k)","Parental leave","Relocation","$300-475K total"],
      dayInLife: {overview:"70-80 hours with efficiency focus. Balance execution, management, clients. Supportive culture with reasonable hours.",schedule:[{time:"8:30 AM",activity:"Morning",description:"Priorities review"},{time:"9:00 AM",activity:"Team",description:"Analyst coordination"},{time:"10:00 AM",activity:"Client Prep",description:"Meeting preparation"},{time:"11:00 AM",activity:"Modeling",description:"Valuation work"},{time:"12:30 PM",activity:"Lunch",description:"Meal break"},{time:"1:30 PM",activity:"Client Meeting",description:"Presentation"},{time:"3:00 PM",activity:"Follow-Up",description:"Next steps"},{time:"4:30 PM",activity:"Pitch",description:"New business"},{time:"6:00 PM",activity:"Mentoring",description:"Development"},{time:"6:45 PM",activity:"Dinner",description:"Break"},{time:"7:30 PM",activity:"Review",description:"Quality check"},{time:"9:00 PM",activity:"Wrap",description:"Depart ~9:30pm"}]},
    ...
    'equity-research-analyst': {
      roleDescription: "Equity Research Analysts at Wells Fargo deliver investment analysis with practical, client-focused approach. Cover sectors serving institutional clients. Supportive culture, reasonable hours, strong training, middle-market and large-cap focus.",
      responsibilities: ["Build financial models","Publish research reports","Conduct industry research","Analyze earnings","Develop investment views","Host client calls","Monitor sector trends","Collaborate with sales/trading","Attend industry events"],
      growthOpportunities: ["Senior Analyst","Sector expertise","Buy-side exits","Client access","Investor network","Career transitions","$325K-$650K+ senior"],
      interviewProcess: [{step:1,title:"Phone",description:"30min background and interests.",duration:"30 minutes"},{step:2,title:"Stock Pitch",description:"60min pitch and technical.",duration:"60 minutes"},{step:3,title:"Superday",description:"4-5 interviews with team.",duration:"4-5 hours"},{step:4,title:"Offer",description:"$80-95K base UG, $100-115K MBA."}],
      technicalQuestions: ["Valuation approach?","EV vs equity?","DCF construction?","Statements linkage?","Sector valuation?","GAAP vs EBITDA?","Multiple selection?","FCF calculation?","ROIC drivers?","Comps building?","Adjustments?","Normalized earnings?","Growth/margin relationship?","PEG usage?","M&A evaluation?","Transition valuation?"],
      behavioralQuestions: ["Why Wells research?","Stock idea?","Sector interest?","Market awareness?","Differentiated view?","View change?","Research challenges?","MD disagreement?","Controversial defense?","Conviction process?","Quant/qual balance?","Analysis example?","Great analyst traits?","New sector approach?","Wells platform?","Interesting stock?"],
      whatTheyLookFor: ["Analytical ability","Curiosity","Communication","Independent thinking","Finance knowledge","Detail focus","Industry understanding","Professional maturity","Work ethic","Collaboration","Integrity"],
      interviewTips: ["Solid stock pitch","Sector knowledge","Read Wells research","Master valuation","Market reading","Modeling practice","Business understanding","Good questions","Research approach","Multiple ideas","Show passion","Counter-args ready","Market knowledge","Regulatory awareness","Explain clearly"],
      salary: {min:80000,max:95000},
      compensation: ["$80-95K base (UG)","$100-115K (MBA)","$30-55K bonus","$10-15K signing","$120-165K total Y1","Performance increases","Seniors $325K-$650K+","Meal allowances","Health benefits","401(k)","Parental leave","CFA support"],
      dayInLife: {overview:"7am-7pm normal, 9pm earnings. Practical analysis. Sector development. Good balance.",schedule:[{time:"7:00 AM",activity:"Markets",description:"Review overnight"},{time:"8:00 AM",activity:"Meeting",description:"Team sync"},{time:"9:00 AM",activity:"Model",description:"Updates"},{time:"10:30 AM",activity:"Management",description:"Company call"},{time:"12:00 PM",activity:"Lunch",description:"Research reading"},{time:"1:00 PM",activity:"Client",description:"Investor call"},{time:"2:30 PM",activity:"Writing",description:"Report draft"},{time:"4:00 PM",activity:"Channel Check",description:"Industry insights"},{time:"5:00 PM",activity:"Review",description:"Feedback"},{time:"6:00 PM",activity:"Edits",description:"Finalize"},{time:"7:00 PM",activity:"Wrap",description:"Depart"}]},
      similarRoles: [{companyName:"Goldman Sachs",companySlug:"goldman-sachs",industry:"Finance"},{companyName:"JPMorgan Chase",companySlug:"jpmorgan",industry:"Finance"},{companyName:"Morgan Stanley",companySlug:"morgan-stanley",industry:"Finance"},{companyName:"Bank of America",companySlug:"bank-of-america",industry:"Finance"},{companyName:"Citigroup",companySlug:"citigroup",industry:"Finance"}]
    },
    'sales-trading-analyst': {
      roleDescription: "Sales & Trading Analysts at Wells Fargo work in Global Markets executing trades and serving institutional clients. Middle-market and large-cap focus. Collaborative environment, strong training, reasonable hours, West Coast presence.",
      responsibilities: ["Execute client trades","Monitor markets","Build pricing models","Manage P&L","Client relationships","Market analysis","Team collaboration","Market commentary","Volatility support"],
      growthOpportunities: ["Associate 2-3 years","Product specialization","Senior roles","Regional opportunities","Buy-side exits","Markets skills","Technology","Performance comp"],
      interviewProcess: [{step:1,title:"Phone",description:"30min markets interest.",duration:"30 minutes"},{step:2,title:"HireVue",description:"45min technical.",duration:"45 minutes"},{step:3,title:"Superday",description:"4-5 interviews technical and fit.",duration:"4-5 hours"},{step:4,title:"Offer",description:"$80-100K base, bonus, desk."}],
      technicalQuestions: ["Coin EV?","Rates/bonds?","Options basics?","Market-making?","Gap factors?","Hedging?","FX parity?","Fair coin?","Vol types?","Forward pricing?","Beta?","Greeks?","Fed impact?","Risk types?","Curve?","Bond P&L?"],
      behavioralQuestions: ["Why Wells S&T?","Sales vs trading?","Quick decision?","Asset interest?","Pressure?","Markets news?","Mistake?","Trader qualities?","Market following?","Quant problem?","Trade idea?","Competitive win?","Derivatives explanation?","Market view?","Deadlines?","Wells platform?"],
      whatTheyLookFor: ["Quant skills","Markets passion","Fast thinking","Competitiveness","Communication","Composure","Team fit","Market sense","Risk discipline","Curiosity","Culture fit"],
      interviewTips: ["Follow markets","Master math","Know mechanics","Views prepared","Practice puzzles","Desk research","S&T story","Personality","Ideas ready","Wells strengths","Sales focus","Trading focus","Volatility knowledge","Vocal process","Humility"],
