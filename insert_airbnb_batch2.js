...
const newRolesContent = fs.readFileSync('temp_airbnb_roles_batch2.js', 'utf8');

// Find lyft section to locate end of airbnb
...
// Find the last closing brace of airbnb section before lyft
const beforeLyft = mainContent.substring(0, lyftStart);
const lastRoleEnd = beforeLyft.lastIndexOf("    }");

if (lastRoleEnd === -1) {
  console.error("Could not find last role end in airbnb section");
  process.exit(1);
}
...
console.log("Airbnb batch 2 roles inserted successfully!");
